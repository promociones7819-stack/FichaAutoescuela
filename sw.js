const CACHE='ficha-autoescuela-v5';
const ASSETS=['./','index.html','styles.css','app.js?v=5','data.js?v=5','compat.js?v=5','history-enhance.js?v=5','pdf-enhance.js?v=5','manifest.webmanifest'];
